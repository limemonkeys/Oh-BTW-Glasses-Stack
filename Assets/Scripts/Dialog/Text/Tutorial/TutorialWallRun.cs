...
public class TutorialWallRun : MonoBehaviour
{
        ...
        transform.Find("message").GetComponent<Button_UI>().ClickFunc = () =>
        {
            ...
            else 
            {
                string[] messageArray = new string[]{
                    "You can wall run by moving forward and jumping towards the wall.",
                    "You'll be able to surf from one wall to the other so keep pushing forward!"
                };
    ...
    void Start()
    {
        ...
        TextWriter.AddWriter_Static(messageText, "Now for the advanced stuff. Wall Running.", 0.05f, true, true, StopMewingSound);
    }
