...
public class TutorialCrouchWalk : MonoBehaviour
{
        ...
        transform.Find("message").GetComponent<Button_UI>().ClickFunc = () =>
        {
            ...
            else 
            {
                string[] messageArray = new string[]{
                    "Sometimes a full slide won't cut it. Once you come to a halt you'll begin crouch walking."
                };
    ...
    void Start()
    {
        ...
        TextWriter.AddWriter_Static(messageText, "You're a natural. Now for the crouch walk.", 0.05f, true, true, StopMewingSound);
    }
